...
- Calcular o salário dos funcionários com um aumento de 10%;
- Calcular o custo total que o RH terá que pagar; e
- Calcular a diferença dos salários antigos pros atuais


Pergunta 1 - resultado final?
R = chegar no resultado final de cada item solicitado

Pergunta 2 - O que eu preciso de informaçoes pra chegar nesse resultado?
R = 
1 - Calcular os salários reajustados;
2 - Armazenar os acúmulos em uma variável (valor total pro RH pagar); e
3 - Calcular a diferença de cada salário (antigo, novo)

Pergunta 3 - Passo a passo👇

Passo a passo:
1 - Calcular os saláriosreajustados;
2 - Armazenar os acúmulos em uma variável (valor total pro RH pagar); e
3 - Calcular a diferença de cada salário (antigo, novo)
